...
- Generated at: 2026-04-21 09:38:05 UTC
- Model: `Qwen/Qwen2.5-1.5B-Instruct (few-shot)`
- Test samples: 10
...
- masking_recall: 0.59 (58.82%)
- over_masking_rate: 0.35 (35.48%)
- text_preservation: 0.99 (98.81%)
...
```text
I'd like to know if there are any charges incurred when transferring the payment to my bank account with [MASK]. If yes, could you please tell me in details?
```
...
```text
"Hello, [PREFIX], we have detected irregular activities on our [PRODUCT_NAME] account number [ACCOUNT_NUMBER] with a transaction amount of [TRANSACTION_AMOUNT] Canadian Dollar. Can you please look into this matter and ensure that our procedures were followed correctly?"
```
...
```text
For your financial protection, we would like to confirm the credit card [CREDIT_CARD_NUMBER] with CVV [CVV_NUMBER] is authorized for payments. A test transaction of ₦[TRANSACTION_AMOUNT] will be processed.
```
...
```text
Hi [PREFIX], I need assistance with your credit card rewards program. Your username is [USERNAME] and your SSN is [SSN].
```
