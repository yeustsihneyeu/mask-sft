...
- Generated at: 2026-04-21 10:04:59 UTC
- Model: `microsoft/deberta-v3-base (fine-tuned NER + post-processing)`
- Test samples: 10
...
```text
For your financial protection, we would like to confirm the credit card [CREDITCARDNUMBER] with CVV 174 is authorized for payments. A test transaction of [CURRENCYSYMBOL][AMOUNT] will be processed.
```
...
```text
Hi [PREFIX], I need assistance with my credit card rewards program. My username is [USERNAME] and my SSN is [SSN]ER].
```
